...
void move(int rightDrive, int leftDrive int distance) {
	...
	while (nMotorEncoder[rightDriveMotor] < distance * 10) // TODO the distance conversion goes here
	{
...
void arm(int rightArm, int leftArm, int delta_height) {
	...
	while (nMotorEncoder[rightArmMotor] < delta_height * 10) // TODO the distance conversion goes here
	{
